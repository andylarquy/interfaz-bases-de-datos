...
import { VentanaConfirmacionComponent } from './components/VentanaConfirmacion/VentanaConfirmacion.component';
...
@NgModule({
  ...
  entryComponents: [EditarDocumentoComponent, VentanaConfirmacionComponent]
})
